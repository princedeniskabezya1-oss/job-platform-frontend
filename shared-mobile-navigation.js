  ...
  function installCanonicalStyles(){
    ...
    style.textContent=`
      ...
      @media(max-width:760px){
        ...
        .mobile-nav.is-pulled-down{height:calc(5px + env(safe-area-inset-bottom,0px))!important;min-height:5px!important;padding-bottom:env(safe-area-inset-bottom,0px)!important;background:rgba(255,255,255,.82)!important;border-top-color:rgba(210,210,210,.55)!important;-webkit-backdrop-filter:blur(10px)!important;backdrop-filter:blur(10px)!important;transform:none!important;opacity:1!important;pointer-events:none!important;transition:none!important}
        .mobile-nav.is-pulled-down>a,.mobile-nav.is-pulled-down>button{display:none!important}
      }
    `;
