...
const count=s.split(needle).length-1;if(count<1)throw new Error('venture detail endpoint anchor missing');
s=s.split(needle).join(replacement);return s;
});
